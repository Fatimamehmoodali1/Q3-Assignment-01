...
st.write("Transfrom your files between CSV and Excels formats with built-in data cleaning and visualization!")
...
if uploaded_files:
    for file in uploaded_files:
        ...
        st.subheader("🛠️Date Cleaning Options")
        ...
        # Choose Specific Colomns to Keep or Convert
        ...
        st.subheader("🔄Convertions Options")
        ...
        if st.button(f"Convert {file.name}"):
            ...
            if conversion_type == "CSV":
                ...
                df.tu_excel(buffer,index=False)
            ...
            # Download Button
            st.download_button(
                label=" ⬇️Download {file.name} as {conversion_type}",
                data=buffer,
                filename=file_name,
                mime=mime_type
            )  
